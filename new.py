...
def update_tables():
    try:
        ...
        cursor.execute(
            "INSERT INTO users (login, psw, name, admin) "
            "VALUES (%s, %s, %s, %s)",
            ('admin',
             '$2b$12$lzAgnuuRHRMd5xRABM7QLeoQfOxCkRvVHdrEmrt8j8OCEYUo7cFtu',
             'Админ', 1))
        ...
        cursor.execute(
            ...
            "VALUES (%s, %s, %s)",
            (1,
             'Тестовая заметка создаваемая при обновлении БД пользователя с ид 1.',
             1))
        ...
        cursor.execute(
            ...
            "VALUES (%s, %s, %s)",
            (2,
             'Тестовая заметка создаваемая при обновлении БД пользователя с ид 2.',
             1))
        print("Запись добавлена")
        conn.commit()
        ...
        cursor.execute(
            ...
            "VALUES (%s, %s, %s)",
            (3,
             'Тестовая заметка создаваемая при обновлении БД пользователя с ид 3.',
             1))
        print("Запись добавлена")
        conn.commit()
